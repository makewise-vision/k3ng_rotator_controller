...
#define FEATURE_ADC_RESOLUTION14   // 14 bit ADC UNO R4 family
...
#define FEATURE_JAMMER_COMMAND            // J command: pulse jammer_pin for JAMMER_ACTIVE_TIME_MS, retriggerable
