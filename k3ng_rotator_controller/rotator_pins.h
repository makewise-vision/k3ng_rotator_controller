...
#define rotate_cw_pwm 6          // optional - PWM CW output - set to 0 to disable (must be PWM capable pin)
#define rotate_ccw_pwm 7         // optional - PWM CCW output - set to 0 to disable (must be PWM capable pin)
...
/*----------- elevation pins --------------*/
  ...
  #define rotate_up_pwm 8           // optional - PWM UP output - set to 0 to disable (must be PWM capable pin)
  #define rotate_down_pwm 9         // optional - PWM DOWN output - set to 0 to disable (must be PWM capable pin)
...
// rotary encoder pins and options
  ...
  #define AZ_POSITION_PULSE_PIN_INTERRUPT 2             // Uno: pin 2 = interrupt 0, pin 3 = interrupt 1 ; Mega: pin 2 = interrupt 0, pin 3 = interrupt 1, pin 21 = interrupt 2, pin 20 = interrupt 3, pin 19 = interrupt 4, pin 18 = interrupt 5
  ...
  #define EL_POSITION_PULSE_PIN_INTERRUPT 3             // Uno: pin 2 = interrupt 0, pin 3 = interrupt 1 ; Mega: pin 2 = interrupt 0, pin 3 = interrupt 1, pin 21 = interrupt 2, pin 20 = interrupt 3, pin 19 = interrupt 4, pin 18 = interrupt 5
#endif                                                // read http://arduino.cc/en/Reference/AttachInterrupt for details on hardware and interrupts
...
#define heading_reading_inhibit_pin 0 // input - a high will cause the controller to suspend taking azimuth (and elevation) readings; use when RF interferes with sensors
  ...
  #define az_limit_sense_pin 10  // input - low stops azimuthal rotation
  #define el_limit_sense_pin 11  // input - low stops elevation rotation
